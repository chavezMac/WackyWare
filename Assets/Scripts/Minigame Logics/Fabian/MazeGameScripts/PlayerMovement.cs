...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 startPoint = new Vector3(transform.transform.position.x,(col.center.y + transform.position.y),transform.position.z);
   ...
   void OnTriggerEnter(Collider other)
   {
       if (other.gameObject.CompareTag("FabianGame3Collectibles"))
       {
           ...
           else if (other.gameObject.name == "PortalSphere")
           {
               other.gameObject.SetActive(false);
