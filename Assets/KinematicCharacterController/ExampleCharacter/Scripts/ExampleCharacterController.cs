...
namespace KinematicCharacterController.Examples
{
    ...
    public class ExampleCharacterController : MonoBehaviour, ICharacterController
    {
                ...
                case CharacterState.Default:
                    {
                        ...
                        if (Motor.GroundingStatus.IsStableOnGround)
                        {
                            ...
                            float forward = Vector3.Dot(currentVelocity, Motor.CharacterForward);
        ...
        if(other.gameObject.CompareTag("PickUp")) {
            ...
            other.gameObject.GetComponentInChildren<UnityEngine.AI.NavMeshAgent>().enabled = false;
            other.gameObject.GetComponentInChildren<UnityEngine.AI.NavMeshAgent>().speed = 6;
